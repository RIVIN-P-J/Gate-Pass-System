    ...
    <>
      <div>
        ...
        <div className="mt-2 text-zinc-600 dark:text-zinc-300">
          Access your gatepass dashboard with secure role-based login.
        </div>

        <form onSubmit={onSubmit} className="mt-7 grid gap-4">
          <div>
            <div className="text-sm text-zinc-600 dark:text-zinc-300 mb-2">Email</div>
          ...
          <div>
            <div className="text-sm text-zinc-600 dark:text-zinc-300 mb-2">Password</div>
            <MotionDiv whileHover={{ y: -1 }} transition={{ type: 'spring', stiffness: 260, damping: 18 }}>
              <input
                className="input"
                type="password"
        ...
        <MotionDiv
          className="mt-6 rounded-2xl bg-white/5 border border-white/10 p-4 text-sm text-zinc-600 dark:text-zinc-300"
